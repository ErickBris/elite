			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo site_url('mixes');?>">Mixes</a> <span class="divider"></span></li>
				<li>Add New Mix</li>
			</ul>
			
			<?php
			$attributes = array('id' => 'feed-form','enctype' => 'multipart/form-data');
			echo form_open(site_url('mixes/add'), $attributes);
			?>
				<legend>Mix Information</legend>
