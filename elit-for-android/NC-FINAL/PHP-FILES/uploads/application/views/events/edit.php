			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo site_url('events');?>">Event List</a> <span class="divider"></span></li>
				<li>Update event</li>
			</ul>
			...
			echo form_open(site_url("events/edit/".$news->id), $attributes);
			?>
				<div class="row">
					<div class="col-sm-5">
						...
						<div class="form-group">
						    ...
						    <input class="form-control" type="text"  name="datatime" data-date-format="MM/DD/YYYY" value="<?php echo $news->datatime;?>">
						...
						<a href="<?php echo site_url('events');?>" class="btn">Cancel</a>
					</div>
					
					<div class="col-sm-7">
						<b>Poster</b> <a class="btn btn-primary btn-upload pull-right" data-toggle="modal" data-target="#uploadImage">Add Poster</a>
						<hr/>			
						<?php
							$images = $this->image->get_all_by_type($news->id, 'event')->result();
							if(count($images) > 0):
						?>
							<div class="row">
							<?php
			...
			<div class="modal fade"  id="uploadImage">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						echo form_open(site_url("events/upload/".$news->id), $attributes);
						?>
			...
			<script>
				$(document).ready(function(){
					...
					$('.detail-img').click(function(e){
						...
						var action = "<?php echo site_url("events/edit_image/".$news->id);?>";
					...
					$('.delete-img').click(function(e){
						...
						var id = $(this).attr('id');
						var image = $(this).attr('image');
						var action = '<?php echo site_url('events/delete_image/'.$news->id);?>/' + id + '/' + image;
