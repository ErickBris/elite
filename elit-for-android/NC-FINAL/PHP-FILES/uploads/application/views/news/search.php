				...
				<div class='col-sm-9'>
					...
					?>
						<div class="form-group">
					  	...
					  	<a href='<?php echo site_url('newsies');?>' class="btn btn-default">Reset</a>
					</form>
				</div>	
				<div class='col-sm-3'>
					<a href='<?php echo site_url('newsies/add');?>' class='btn btn-primary pull-right'><span class='glyphicon glyphicon-plus'></span> Add News</a>
				</div>
			</div>
			...
			<table class="table table-striped table-bordered">
				...
				?>
						<tr>
							...
							<?php if(in_array('edit',$allowed_accesses)):?>
							<td><a href='<?php echo site_url("newsies/edit/".$feed->id);?>'><i class='glyphicon glyphicon-edit'></i></a></td>
							<?php endif;?>
							
							
							<?php if(in_array('delete',$allowed_accesses)):?>
							<td><a href='<?php echo site_url("newsies/delete/".$feed->id);?>'><i class='glyphicon glyphicon-trash'></i></a></td>
							<?php endif;?>
