			...
			echo form_open(site_url("djs/edit/".$news->id), $attributes);
			?>
				<div class="row">
					<div class="col-sm-5">
					...
					<div class="col-sm-7">
						<b>Dj photo</b> <a class="btn btn-primary btn-upload pull-right" data-toggle="modal" data-target="#uploadImage">Add Image</a>
						<br/>
						*please upload image with size 640x40px
						<hr/>
								
						<?php
							$images = $this->image->get_all_by_type($news->id, 'dj')->result();
							if(count($images) > 0):
						?>
							<div class="row">
							<?php
			...
			<div class="modal fade"  id="uploadImage">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						echo form_open(site_url("djs/upload/".$news->id), $attributes);
						?>
			...
			<script>
				$(document).ready(function(){
					...
					$('.detail-img').click(function(e){
						...
						var action = "<?php echo site_url("djs/edit_image/".$news->id);?>";
					...
					$('.delete-img').click(function(e){
						...
						var id = $(this).attr('id');
						var image = $(this).attr('image');
						var action = '<?php echo site_url('djs/delete_image/'.$news->id);?>/' + id + '/' + image;
