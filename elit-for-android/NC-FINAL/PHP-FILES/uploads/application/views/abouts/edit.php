			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo site_url('newsies');?>">About</a> <span class="divider"></span></li>
				<li>Update about</li>
			</ul>
			...
			echo form_open(site_url("abouts/edit/".$news->id), $attributes);
			?>
				<div class="row">
					<div class="col-sm-5">
						...
						<div class="form-group">
							<label>Adress</label>
							<input class="form-control" type="text" placeholder="title" name='adres' id='adres'
							 value="<?php echo $news->adres;?>">
						</div>
						<div class="form-group">
							<label>Phone</label>
							<input class="form-control" type="text" placeholder="title" name='phone' id='phone'
							 value="<?php echo $news->phone;?>">
						</div>
						
						<input type="submit" value="Update" class="btn btn-primary"/>
						<a href="<?php echo site_url('abouts');?>" class="btn">Cancel</a>
					</div>
						...
						?>
							...
							<?php
								...
								foreach ($images as $img) {
									...
									echo '<div class="col-md-4" style="height:100"><div class="imageg">'.
