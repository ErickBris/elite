			...
			echo form_open(site_url("photos/edit/".$news->id), $attributes);
			?>
				<div class="row">
					<div class="col-sm-5">
						...
						<a href="<?php echo site_url('photos');?>" class="btn">Cancel</a>
					</div>
					...
					<div class="col-sm-7">
						...
						<hr/>			
						<?php
							$images = $this->image->get_all_by_type($news->id, 'photo')->result();
							if(count($images) > 0):
						?>
							<div class="row">
							<?php
			...
			<div class="modal fade"  id="uploadImage">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						echo form_open(site_url("photos/upload/".$news->id), $attributes);
						?>
			...
			<script>
				$(document).ready(function(){
					...
					$('.detail-img').click(function(e){
						...
						var action = "<?php echo site_url("photos/edit_image/".$news->id);?>";
					...
					$('.delete-img').click(function(e){
						...
						var id = $(this).attr('id');
						var image = $(this).attr('image');
						var action = '<?php echo site_url('photos/delete_image/'.$news->id);?>/' + id + '/' + image;
